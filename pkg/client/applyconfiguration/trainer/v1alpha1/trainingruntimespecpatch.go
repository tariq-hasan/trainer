...
// TrainingRuntimeSpecPatchApplyConfiguration represents a declarative configuration of the TrainingRuntimeSpecPatch type for use
// with apply.
//
// TrainingRuntimeSpecPatch mirrors TrainingRuntimeSpec but only exposes
// the fields managers are permitted to patch.
type TrainingRuntimeSpecPatchApplyConfiguration struct {
	// template patches the JobSet template.
	Template *JobSetTemplatePatchApplyConfiguration `json:"template,omitempty"`
}
