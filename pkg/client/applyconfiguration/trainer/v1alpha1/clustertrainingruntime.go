...
func ClusterTrainingRuntime(name string) *ClusterTrainingRuntimeApplyConfiguration {
	...
	b.WithName(name)
	b.WithKind("ClusterTrainingRuntime")
...
func (b *ClusterTrainingRuntimeApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
...
func (b *ClusterTrainingRuntimeApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *ClusterTrainingRuntimeApplyConfiguration) GetAPIVersion() *string {
...
func (b *ClusterTrainingRuntimeApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
