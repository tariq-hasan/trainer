...
// JobSetTemplatePatchApplyConfiguration represents a declarative configuration of the JobSetTemplatePatch type for use
// with apply.
//
...
type JobSetTemplatePatchApplyConfiguration struct {
	...
	Spec *JobSetSpecPatchApplyConfiguration `json:"spec,omitempty"`
}
