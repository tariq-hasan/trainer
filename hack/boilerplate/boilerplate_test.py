...
class TestBoilerplate(unittest.TestCase):
    ...
    def test_pass_no_year(self):
        ...
        passes, error = boilerplate.file_passes(filepath, refs, regexs, self.test_dir)
    ...
    def test_fail_wrong_header(self):
        ...
        passes, _ = boilerplate.file_passes(filepath, refs, regexs, self.test_dir)
