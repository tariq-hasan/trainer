...
class TrainerV1alpha1TrainJobTemplateSpec(BaseModel):
    ...
    """ # noqa: E501
    metadata: Optional[IoK8sApimachineryPkgApisMetaV1ObjectMeta] = Field(default=None, description="metadata is the metadata for the train job.")
    spec: TrainerV1alpha1TrainJobSpec = Field(description="spec is the spec for the train job.")
